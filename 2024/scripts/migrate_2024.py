...
SRC = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("/Users/licheng/Documents/zhipu/.zcode/workspace/default/listing-inquiry-digest/companies_2024")
STATE = SRC.parent / "state"
OUT = KB / "cases"
CUTOFF_DEFAULT = "2026-08-28"
...
def load_meta():
    ...
    meta = {}
    for p in sorted(STATE.glob("distill2024_*.json")):
